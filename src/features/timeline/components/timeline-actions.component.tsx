  ...
  <div className="timeline-actions" style={{ margin: '20px 0' }}>
    ...
    <div className="actions-buttons-section" style={{
      ...
      <div className="toolbar-actions" style={{
        ...
        <div className="navigation-controls" style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
          <Button
        ...
        {isCurrentOrFutureWeek && (
          <div className="action-buttons" style={{ display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
            <Button
